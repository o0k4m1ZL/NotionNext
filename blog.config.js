...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '00K4M1', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '野🐱子、愁闲🐟', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://00K4M1.com', // 网站地址
